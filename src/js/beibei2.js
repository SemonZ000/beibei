document.addEventListener("DOMContentLoaded",function(){
        let main=document.querySelector(".main-c-l")
        var goods =main.children;
        ...
        // 事件委托
        // 利用事件委托实现添加到购物车的效果
        goods.onmouseover= function(e){
            // Event对象兼容
            e = e || window.event;

            // 事件源对象兼容
            var target = e.target || e.srcElement;
            if(target.parentNode.parentNode.parentNode.className==="main-c-l"){
                console.log(this)
            }
